...
public class CustomerService {
    ...
    public CustomerResponse servicePost(CustomerRequest request) {
        ...
        if (customerOpt.isPresent() == true) {
            return new CustomerResponse(request.getiD(), "ID already exist", "Error", 0, 0);
        } else {
    ...
    public CustomerResponse serviceGetID(String iD)
    {
        ...
        {
            return new CustomerResponse(iD,"ID doesn't exist","Error",0,0);
        } else {
    ...
    public CustomerResponse serviceGetName(String firstName)
    {
        ...
        {
            return new CustomerResponse("This First Name doesn't exist",firstName,"Error",0,0);
        }
